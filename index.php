...
<body class="index-page">
    ...
    <div class="page-header header-filter" data-parallax="true" style="background-image: url(assets/img/usict.jpg); transform: translate3d(0px, 0px, 0px);">
        <div class="container">
            <div class="row">
				<div class="col-md-6">
					<h1 class="title">Guru Gobind Singh Indraprastha University</h1>
                    <h4>Your story start with us.</h4>
                    <br>
                </div>
            </div>
        </div>
		...
		<footer class="footer footer-white footer-big">
			<div class="container">
				<div class="content">
					<div class="row">
						<div class="col-md-5 col-sm-12">
							...
							<p>GGSIPU is first University established in 1998 by Govt. of NCT of Delhi under the 
							provisions of Guru Gobind Singh Indraprastha University Act, 1998 read with its 
				...
				<div class="copyright pull-center">
					...
					2016 GGSIPU All rights reserved..	
				</div>
			</div>
		</footer>
